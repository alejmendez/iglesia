                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="name">{{ __('voyager.post.tags') }}</label>
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'tags',
                                    '_field_trans' => get_field_translations($dataTypeContent, 'tags')
                                ])
                                <input type="text" class="form-control" id="tags" name="tags"
                                    placeholder="{{ __('voyager.post.tags') }}"
                                    {{!! isFieldSlugAutoGenerator($dataType, $dataTypeContent, "tags") !!}}
                                    value="@if(isset($dataTypeContent->tags)){{ $dataTypeContent->tagList }}@endif">
                            </div>
                            <div class="form-group">
